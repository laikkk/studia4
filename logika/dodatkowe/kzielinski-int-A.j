...
7 E∧F∨E∧G 
IS
SEQ ("∨ elim"[A,B,C\6,5,4]) (hyp[A\7]) (cut[B,C\3,4]) (LAYOUT "∧ elim" (0) ("∧ elim(R)"[A,B\1,3]) (hyp[A\6])) (cut[B,C\1,4]) (LAYOUT "∧ elim" (0) ("∧ elim(L)"[A,B\1,3]) (hyp[A\6])) (cut[B,C\0,4]) (LAYOUT "∨ intro" (0) ("∨ intro(L)"[B,A\2,3]) (hyp[A\3])) ("∧ intro"[A,B\1,0]) (hyp[A\1]) (hyp[A\0]) (cut[B,C\2,4]) (LAYOUT "∧ elim" (0) ("∧ elim(R)"[A,B\1,2]) (hyp[A\5])) (cut[B,C\1,4]) (LAYOUT "∧ elim" (0) ("∧ elim(L)"[A,B\1,2]) (hyp[A\5])) (cut[B,C\0,4]) (LAYOUT "∨ intro" (0) ("∨ intro(R)"[B,A\3,2]) (hyp[A\2])) ("∧ intro"[A,B\1,0]) (hyp[A\1]) (hyp[A\0])
END
CONJECTUREPANEL "Intuicjonistyczny rachunek zdań - 01"
PROOF "E→F→G ⊢ (E→F)→(E→G)"
INFER E→F→G 
